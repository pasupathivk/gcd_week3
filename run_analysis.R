...
local.data.file <- './original-dataset.rar'
setwd("C:/Documents and Settings/mob051307040.MOBIUSSERVICES/My Documents/R Programs")
...
# Dump the data set
write.table(tidy.data.set, tidy.data.file)
...
write.table(tidy.avgs.data.set, tidy.avgs.data.file)